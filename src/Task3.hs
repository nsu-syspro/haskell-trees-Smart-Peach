...
listToMap list = listToBST compareKeys list 
...
minsert key val m = tinsert compareKeys (key, val) m
...
mdelete key m = tdelete compareKeys (key, undefined) m 
